...
export default function ProjectTab(props) {
  return (
    <div className="grid place-items-center block h-full rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none text-center">
      <div className="p-2">
        <h1 className="block text-3xl">{props.title}</h1>
        <h3 className="block text-xl text-gray-600">{props.year}</h3>
